 ...
 *
 */
public class ModifiedScrollPane extends JScrollPane {
    ...
    private static final int SB_SIZE = 13;
    private static final Color THUMB_COLOR = Color.BLACK;

    public ModifiedScrollPane(Component view, int vsbPolicy, int hsbPolicy) {
    ...
    private static class ModernScrollBarUI extends BasicScrollBarUI {
        ...
        public ModernScrollBarUI(ModifiedScrollPane sp) {
            this.sp = sp;
        }
